...
void test_timetomiddle_calc(void) {
  ...
  TEST_ASSERT_EQUAL_FLOAT_MESSAGE(0.0, time_to_center, "time to middle should be zero");
  time_to_center =
      model.calculateTimeToCenterInSeconds(stepPositionOfMiddle + 7200);//about a minute from middle
  ...
  void test_speed_calc(void) {
    ...
    TEST_ASSERT_EQUAL_INT_MESSAGE(
        117025, speedInMilliHz, "Smaller great circle should be slower speed");
